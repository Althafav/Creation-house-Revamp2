              ...
              <form>
                <div className="row">
                  <div className="col-12 mb-2">
                    <input type="text" placeholder='Fullname' className='form-control w-75' />
                  </div>
                  <div className="col-12 mb-2">
                    <input type="email" placeholder='Email Address' className='form-control w-75' />

                  </div>

                  <div className="col-12 mb-2" >
                    <input type="text" placeholder='Phone Number' className='form-control w-75' />
